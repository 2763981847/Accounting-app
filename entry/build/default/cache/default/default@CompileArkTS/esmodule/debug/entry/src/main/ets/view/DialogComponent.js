...
export default class DialogComponent extends ViewPU {
    ...
    TabBuilder(index, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.border(this.curIndex === index ? {
                ...
                color: { "id": 16777234, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" }
            } : { color: Color.White });
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.fontColor(this.curIndex === index ? { "id": 16777234, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } : Color.Gray);
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
                        ...
                        const item = _item;
                        {
                            ...
                            const observedDeepRender = () => {
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ...
                                    Column.backgroundColor(this.curType === item.typeText ? { "id": 16777234, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" } : { "id": 16777230, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
                                ...
                                this.observeComponentCreation((elmtId, isInitialRender) => {
                                    ...
                                    Text.fontColor(this.curType === item.typeText ? Color.White : { "id": 16777234, "type": 10001, params: [], "bundleName": "com.example.rdb", "moduleName": "entry" });
